(()=>{
  ...
  // Persistent memory is owned by Agent Core -> gateway -> service-role path.\n  // Browser code must never write directly to acerola_memory.\n  const b=document.getElementById('accountBtn');if(b){b.onclick=open;b.title='Acerola Account';b.setAttribute('aria-label','Open Acerola Account')}
