(()=>{
  ...
  // Persistent memory is owned by Agent Core -> gateway -> service-role path.\n  // Browser code must never write directly to acerola_memory.\n  const b=document.createElement('button');b.id='accountBtn';b.textContent='👤';b.title='Acerola Account';b.setAttribute('aria-label','Open Acerola Account');b.onclick=open;const top=$('.top');if(top){top.insertBefore(b,$('#about'));}else{document.body.appendChild(b)}
